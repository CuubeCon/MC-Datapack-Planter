...
execute store success score @s cc_planterresult if score @s cc_planterCD matches 1100 if data block ~ ~ ~ Items[{id:"minecraft:birch_sapling", Slot:0b}] if block ^ ^-1 ^1 #planter:placeable_land if block ^ ^ ^1 minecraft:air run setblock ^ ^ ^1 minecraft:birch_sapling
...
#Second block
execute as @s store result score @s cc_planter if data block ~ ~ ~ Items[{Slot:0b}] run data get block ~ ~ ~ Items[{Slot:0b}].Count
execute store success score @s cc_planterresult if score @s cc_planterCD matches 1200 if data block ~ ~ ~ Items[{id:"minecraft:birch_sapling", Slot:0b}] if block ^ ^-1 ^2 #planter:placeable_land if block ^ ^ ^2 minecraft:air run setblock ^ ^ ^2 minecraft:birch_sapling
execute if score @s cc_planterresult matches 1 run function planter:decrease_item
execute as @s store result score @s cc_planter_dur if score @s cc_planterresult matches 1 run data get entity @s Item.tag.Damage
execute as @s if score @s cc_planterresult matches 1 run function planter:decrease_tool
scoreboard players reset @s cc_planterresult
#Third block
execute as @s store result score @s cc_planter if data block ~ ~ ~ Items[{Slot:0b}] run data get block ~ ~ ~ Items[{Slot:0b}].Count
execute store success score @s cc_planterresult if score @s cc_planterCD matches 1300 if data block ~ ~ ~ Items[{id:"minecraft:birch_sapling", Slot:0b}] if block ^ ^-1 ^3 #planter:placeable_land if block ^ ^ ^3 minecraft:air run setblock ^ ^ ^3 minecraft:birch_sapling
execute if score @s cc_planterresult matches 1 run function planter:decrease_item
execute as @s store result score @s cc_planter_dur if score @s cc_planterresult matches 1 run data get entity @s Item.tag.Damage
execute as @s if score @s cc_planterresult matches 1 run function planter:decrease_tool
scoreboard players reset @s cc_planterresult
